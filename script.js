    ...
    document.querySelectorAll('.suggestion-btn').forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        if (question === "Discover your relationship health and risk profile.") {
          ...
          const info = `Eunoia is designed specifically for relationship support, with a focus on empathy, emotional clarity, and healthy communication.\n\nUnlike general-purpose AI like ChatGPT, Eunoia follows strict behavioral principles: it does not judge, shame, or escalate conflict. Instead, it helps you understand your emotions, communicate thoughtfully, and set healthy boundaries.\n\nEunoia’s responses are intentionally concise and actionable, so you can quickly apply its guidance in real situations. It also includes purpose-built tools like a relationship health assessment and a Message Lab to help you navigate difficult conversations more effectively.\n\nRather than making decisions for you, Eunoia supports your autonomy—helping you reflect, respond, and grow. In serious situations, it encourages seeking real-world or professional support.\n\nEunoia is not just a general chatbot—it’s a focused, consistent support system for navigating relationships with clarity and care.`;
